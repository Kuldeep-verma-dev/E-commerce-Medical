...
class category(models.Model):
    ...
    MainCategoryName=models.CharField(max_length=40,null=True)
    CPic=models.ImageField(upload_to='static/category/',default="")#or null=True)
    def __str__(self):
        return self.Name


# THIS IS SUB CATEGORY MODEL
